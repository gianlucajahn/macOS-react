  ...
  return (
    <>
        <div className="dock">
            ...
            <div className={`dock-item no-point ${state.dockItem === 4 ? "hovered" : ""} ${state.dockItem === 2 ? "distance-2" : state.dockItem === 3 ? "distance-1" : state.dockItem === 5 ? "distance-1" : state.dockItem === 6 ? "distance-2" : ""}`} id="4" onMouseEnter={selectDockItem} onMouseLeave={resetDock} onClick={()=> window.open("https://code.visualstudio.com/", "_blank")}>
              <div className="tool-tip">VSCode</div>
              <img className="dock-icon" src={require("../../resources/images/webp/vscode.png")} />
            </div>
            <div className={`dock-item no-point ${state.dockItem === 5 ? "hovered" : ""} ${state.dockItem === 3 ? "distance-2" : state.dockItem === 4 ? "distance-1" : state.dockItem === 6 ? "distance-1" : state.dockItem === 7 ? "distance-2" : ""}`} id="5" onMouseEnter={selectDockItem} onMouseLeave={resetDock} onClick={()=> window.open("https://www.apple.com/de/apple-music/", "_blank")}>
            ...
            <div className={`dock-item ${state.dockItem === 7 ? "hovered" : ""} ${state.dockItem === 5 ? "distance-2" : state.dockItem === 6 ? "distance-1" : state.dockItem === 8 ? "distance-1" : state.dockItem === 9 ? "distance-2" : ""}`} id="7" onMouseEnter={selectDockItem} onMouseLeave={resetDock} onClick={()=> window.open("https://github.com/gianlucajahn/macOS-react", "_blank")}>
              <div className="tool-tip">GitHub</div>
              <img className="dock-icon" src={require("../../resources/images/webp/github.png")} />
              <div className="point" />
            </div>
            <div className="division" />
            <div className={`dock-item ${state.dockItem === 8 ? "hovered" : ""} ${state.dockItem === 6 ? "distance-2" : state.dockItem === 7 ? "distance-1" : state.dockItem === 9 ? "distance-1" : ""}`} id="8" onMouseEnter={selectDockItem} onMouseLeave={resetDock} onClick={()=> window.open("https://de.scalable.capital/", "_blank")}>
              <div className="tool-tip">Scalable</div>
              <img className="dock-icon" src={require("../../resources/images/webp/scalable.png")} />
              <div className="point" />
            </div>
            <div className="division" />
            <div className={`dock-item ${state.dockItem === 9 ? "hovered" : ""} ${state.dockItem === 7 ? "distance-2" : state.dockItem === 8 ? "distance-1" : ""}`} id="9" onMouseEnter={selectDockItem} onMouseLeave={resetDock} onClick={()=> window.open("https://twitter.com/Apple", "_blank")}>
